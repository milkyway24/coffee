export const stations = [
    ...
    },
    {
        ...
        descr: 'Желательно обслужить до 21:00, потом выключают лифт, а аппараты не на первом этаже. Точка ведет на само депо. Нас интересует главное здание. Где аппараты спрашивать у охранников или работников депо'
    },
    {
        name: 'Братеево депо',
        number: '2241',
